...
## 1.4.1 - Added Horizon 2603 to version lookup##
#################################################
...
$domain = "ad.domain"
$poolNameToClone = "WIN1A" # Example: "WINPOOL1A"
$poolNameToCreate = "WIN1B" # Example: "WINPOOL1B"
$poolNamingConventionToCreate = "WIN1B{n:fixed=2}" # Example: "VMNAME{n:fixed=2}"
$changePoolDisplayName = $false   # $true or $false -- if true, will use $PoolDisplayNameToCreate to change display name
$PoolDisplayNameToCreate = "Windows Pool 1"
...
$entitlements = Read-Host "Would you like to clone the entitlements from $poolNameToClone to ($poolNameToCreate)? (Y/N)"
