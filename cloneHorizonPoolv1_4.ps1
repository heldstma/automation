...
$domain = "domain.com"
$poolNameToClone = "WIN2A" # Example: "WINPOOL1A"
$poolNameToCreate = "WIN2B" # Example: "WINPOOL1B"
$poolNamingConventionToCreate = "WIN2B{n:fixed=2}" # Example: "VMNAME{n:fixed=2}"
$changePoolDisplayName = $false   # $true or $false -- if true, will use $PoolDisplayNameToCreate to change display name
$PoolDisplayNameToCreate = "Windows Pool 2"
